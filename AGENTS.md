...
- git remote add origin https://github.com/fonn-claw/rankup.git
- git push -u origin main
- npx vercel --yes && npx vercel domains add rankup.demos.fonnit.com && npx vercel --prod
- Set env vars: DATABASE_URL, SESSION_SECRET

## On Completion
When completely finished, run:
openclaw system event --text "BUILD COMPLETE: RankUp — Sales Performance Gamification" --mode now
